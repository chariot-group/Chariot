                    ...
                    <div class="${properties.kcFormGroupClass!}">
                        ...
                        <div id="kc-form-options">
                            <#if realm.resetPasswordAllowed>
                                <span>${msg('login.forgotPasswordText')} <a tabindex="5" href="${url.loginResetCredentialsUrl}">${msg('login.forgotPasswordLink')}</a></span>
                            </#if>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-submit">
                    ...
                    <div id="kc-registration-container">
                        <div id="kc-registration">
                            <span>${msg('login.noAccountText')} <a tabindex="6" href="${url.registrationUrl}">${msg('login.registerLink')}</a></span>
                        </div>
                    </div>
                </div>
            </form>
