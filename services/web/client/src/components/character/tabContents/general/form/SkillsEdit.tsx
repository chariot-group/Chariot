...
const skillsConfig: SkillConfig[] = [
    ...
    { key: "animalHandling", translationKey: "animalHandling", abilityKey: "wisdom", icon: <PawPrint aria-hidden="true" /> },
    { key: "sleightHand", translationKey: "sleightHand", abilityKey: "dexterity", icon: <LockKeyhole aria-hidden="true" /> },
    { key: "history", translationKey: "history", abilityKey: "intelligence", icon: <Notebook aria-hidden="true" /> },
    { key: "intimidation", translationKey: "intimidation", abilityKey: "charisma", icon: <User2Icon aria-hidden="true" /> },
    { key: "insight", translationKey: "insight", abilityKey: "wisdom", icon: <Brain aria-hidden="true" /> },
    { key: "investigation", translationKey: "investigation", abilityKey: "intelligence", icon: <CircleQuestionMark aria-hidden="true" /> },
    ...
    { key: "persuasion", translationKey: "persuasion", abilityKey: "charisma", icon: <MessageSquare aria-hidden="true" /> },
...
export default function SkillsEdit({ form, accentColor, enableHalfProficiency, enableExpertise }: SkillsEditProps) {
     ...
     */
    const calculateSkillBonus = (masteryLevel: number, abilityScore: number, proficiencyBonus: number): number => {
