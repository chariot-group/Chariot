        ...
        <div className="w-full flex flex-col lg:flex-row gap-4 items-start">
            <div className="flex flex-col gap-4 w-full lg:w-2/5" >
                <Card className='gap-2'>
                    <section aria-labelledby="coins-heading" aria-label={t('coinsRegion')}>
                        <h2 id="coins-heading" className={`text-2xl sm:text-3xl font-semibold ${accentColor}`}>
                            {t('coins')}
                        </h2>
                ...
                <Card className='gap-2'>
                    <section aria-labelledby="equipment-heading" aria-label={t('equipmentRegion')}>
                        <h2 id="equipment-heading" className={`text-2xl sm:text-3xl font-semibold ${accentColor}`}>
                            {t('equipment')}
                        </h2>
            ...
            <Card className='w-full lg:min-w-3/5 lg:max-w-3/5 gap-2'>
                <section aria-labelledby="treasure-heading" aria-label={t('treasureRegion')}>
                    <h2 id="treasure-heading" className={`text-start text-2xl sm:text-3xl font-semibold mb-3 ${accentColor}`}>
                        {t('treasure')}
                    </h2>
                    <p className="text-sm sm:text-base">
