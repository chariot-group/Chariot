    ...
    return (
        <Tooltip>
            <TooltipTrigger asChild>
                <div
                    className="relative h-9 bg-white border border-black rounded-full overflow-hidden cursor-help focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                    tabIndex={0}
                    role="img"
                    ...
                    <div className="absolute inset-0 flex items-center justify-between px-2 pointer-events-none">
                        {currentHP > 0 || tempHP > 0 ? (
                            ...
                            <Skull size={32} className='text-black' aria-hidden="true" />
                        )}

                        <div className="font-bold text-xl text-black" aria-hidden="true">
                            {currentHP}/{maxHP}
                        </div>

                        <div className="text-xl font-medium text-black" aria-hidden="true">
                            {tempHP > 0 ? `+${tempHP}PV` : ''}
                        </div>
                    </div>
                </div>
