...
export default function MonsterCodexDialog({
    ...
    const searchMonsters = useCallback(async (query: string, page: number = 1, append: boolean = false) => {
                            ...
                            {isSearching ? (
                                ...
                                if (selectedLang) {
                                    visibleCount = searchResults.filter(item =>
                                        CodexService.getMonsterTranslation(item, selectedLang) !== null
                                    ).length;
                                } else {
                                                ...
                                                if (selectedLang) {
                                                    ...
                                                    return (
                                                        <Card
                                                            ...
                                                            className={`cursor-pointer p-3 hover:border-purple transition-all ${isSelected ? "border-purple border-2" : ""
                                                                }`}
                                                        >
