        ...
        <div>
          <div className="mx-auto px-4 sm:px-6 md:px-8 py-4">
            <div className="flex flex-col-reverse xl:flex-row items-start xl:items-end xl:justify-between gap-4 xl:gap-8">
              {/* Onglets */}
              <TabsList className="bg-transparent gap-1 sm:gap-3 md:gap-4 flex-wrap justify-start self-start xl:self-end" role="tablist" aria-label={t("tabs.general")}>
              ...
              <div className="flex flex-row justify-end items-end gap-3 sm:gap-4 md:gap-5 shrink-0 w-full xl:w-auto">
                ...
                {/* Photo de profil */}
                <div className="w-28 h-20 sm:w-20 sm:h-24 md:w-40 md:h-28 rounded-[18px] bg-gray flex items-center justify-center overflow-hidden shrink-0" role="img" aria-label={t("placeholder.noImage")}>
