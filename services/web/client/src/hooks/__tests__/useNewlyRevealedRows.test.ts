...
describe("FR-tracker-combatant-reveal — findNewIds (useNewlyRevealedRows core logic)", () => {
  ...
  it("nominal: REVEAL_DURATION_MS is 3000 ms as specified by FR-tracker-combatant-reveal", () => {
