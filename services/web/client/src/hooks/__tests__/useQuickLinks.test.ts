...
/**
 * Tests unitaires pour les utilitaires des liens rapides (FR-sidebar-quick-links).
 ...
 */
describe("FR-sidebar-quick-links — quickLinkIcons utilities", () => {
  // ── nominal ─────────────────────────────────────────────────────────────────
...
describe("FR-sidebar-quick-links — UpdateQuickLinkDto", () => {
