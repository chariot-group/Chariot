...
const EARLY_CLOSE_EPSILON_MS = 2 * 60 * 1000;
...
export function isEarlyClose(launchedAt: Date, deletedAt: Date): boolean {
    return deletedAt.getTime() - launchedAt.getTime() < SESSION_DURATION_MS - EARLY_CLOSE_EPSILON_MS;
}
